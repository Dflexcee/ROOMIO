-- Admin Migration Schema for PHP Backend
-- This file contains all the SQL tables needed for admin functionality
...
-- 9. Payment Settings Table (feature definitions)
...
INSERT INTO payment_settings (feature_name, label, description, unlock_price, is_locked, duration_type, duration_value) VALUES
...
CREATE INDEX idx_user_payments_feature ON user_payments(feature_name);
