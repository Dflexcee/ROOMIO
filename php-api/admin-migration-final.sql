-- Final Admin Migration - This will definitely work!
-- This creates all admin tables with unique names to avoid conflicts
...
CREATE TABLE IF NOT EXISTS admin_sms_settings (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS admin_payment_gateway_settings (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
-- 8. User Payments Table
CREATE TABLE IF NOT EXISTS admin_user_payments (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
...
-- Insert default data
INSERT IGNORE INTO admin_email_templates (template_key, name, subject, body) VALUES
...
CREATE INDEX IF NOT EXISTS idx_admin_user_payments_user_id ON admin_user_payments(user_id);
CREATE INDEX IF NOT EXISTS idx_admin_user_payments_feature ON admin_user_payments(feature_name);
